<?php
/**
 * @version $Id: easyblog.php 40 2014-09-08 14:28:34Z szymon $
...
class plgDJMediatoolsEasyblog extends JPlugin
{
	...
	public function onAlbumPrepare(&$source, &$params)
	{
		...
		foreach($posts as $item){
			...
			if(!empty($image)) $slide->image = str_replace(JURI::base(), '', $image->getSource('original'));
			else $slide->image = DJMediatoolsLayoutHelper::getImageFromText($item->intro);
