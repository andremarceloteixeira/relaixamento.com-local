		...
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-right hidden-phone">
				<select name="filter_source" class="inputbox" onchange="this.form.submit()">
					...
					<?php echo JHtml::_('select.options', array(JHtml::_('select.option', '0', 'COM_DJCLASSIFIEDS_CATEGORY'),JHtml::_('select.option', '1', 'COM_DJCLASSIFIEDS_CONTACT'),JHtml::_('select.option', '2', 'COM_DJCLASSIFIEDS_USER_PROFILE')), 'value', 'text', $this->state->get('filter.source'), true);?>
				</select>
			</div>				
		</div>
	<div class="clr"> </div>
