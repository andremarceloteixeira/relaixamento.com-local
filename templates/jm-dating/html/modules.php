	...
	<<?php echo $moduleTag; ?> class="jm-module <?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
		<<?php echo $moduleTag; ?>  class="jm-module-in">
			<?php if ((bool) $module->showtitle) :?>
		   		<<?php echo $moduleTag; ?> class="jm-title-wrap"><<?php echo $headerTag; ?> class="jm-title <?php echo $params->get('header_class'); ?>"><?php echo $title; ?></<?php echo $headerTag; ?>></<?php echo $moduleTag; ?>>
		   	<?php endif;?>
