<?php
/**
 * @version $Id: helper.php 38 2014-07-29 12:18:47Z szymon $
...
class SkitterSlideshowDJMediatoolsLayoutHelper extends DJMediatoolsLayoutHelper {
	...
	public function addScripts(&$params) {
		...
		$document->addScript('components/com_djmediatools/assets/js/jquery.easing.1.3.js');
		$document->addScript('components/com_djmediatools/assets/js/jquery.animate-colors-min.js');
